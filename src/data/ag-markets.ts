...
export const agMarkets: Market[] = [
  ...
  },
  {
    ...
    heroCopy: 'Highly Pathogenic Avian Influenza and other pathogens can devastate a flock without warning. Genesis360 Ag Dry Fog and BotaniMax bring automated biosecurity protocols to poultry farms without disrupting daily operations.',
