...
export const hvacMarkets: Market[] = [
  {
    ...
    heroCopy: 'Your HVAC system is one of the largest investments in your home. 360HVAC Dry Fog treats coils and ductwork with botanical disinfectant, helping extend equipment life and keep everyday indoor air cleaner.',
    image: hvacLifespan,
  ...
  },
  {
    ...
    heroCopy: 'Biofilm hidden inside coils, drain pans, and ductwork can quietly cut energy efficiency and air quality across an entire building. 360HVAC Dry Fog runs scheduled, automated cycles for air handlers serving offices, schools, and other shared buildings.',
    image: biofilmHvac,
